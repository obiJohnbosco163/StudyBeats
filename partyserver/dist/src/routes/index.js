...
import { getMusicProvider } from '../services/musicProvider.js';
    ...
    app.post('/api/pipeline/analyze', async (c) => {
        try {
            ...
            if (e instanceof AiBlockedError)
                return ApiErrors.badRequest(c, 'AI usage limit reached.');
            if (e instanceof AiError)
                return ApiErrors.internal(c, `AI error: ${e.message}`);
