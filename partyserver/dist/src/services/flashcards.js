...
export async function generateFlashcards(env, text) {
    const trimmed = truncateText(text, MAX_INPUT_CHARS);
    const system = 'You are a study-flashcard writer. Respond with ONLY valid JSON — no markdown fences, no commentary.';
